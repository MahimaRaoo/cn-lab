...
NS_LOG_UNCOND("Flow id :"<<i->first<<"s :"<<t.sourceAddress<<"d :"<<t.destinationAddress);
NS_LOG_UNCOND("Rx packets :"<<i->second.rxPackets);
NS_LOG_UNCOND("Tx packets :"<<i->second.txPackets);
NS_LOG_UNCOND("Lost packets :"<<i->second.lostPackets);

NS_LOG_UNCOND("Throughput :"<<i->second.rxBytes*8.0/(i->second.timeLastRxPacket.GetSeconds()-i->second.timeFirstTxPacket.GetSeconds())/1024<<"kbytes");
